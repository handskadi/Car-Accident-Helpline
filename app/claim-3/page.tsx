    ...
    <main className="w-full text-gray-800">
      ...
      >
        ...
        >
          ...
          <span className="font-extrabold text-lg">(888) 841-1943</span>
        </Link>
      ...
      <section className="w-full px-4 lg:px-80 py-8 bg-white">
        <div className="flex flex-col lg:flex-row items-center gap-10 py-8 border-b border-[#33E5F5] ">
          ...
          <div className="lg:w-1/2">
            ...
            <CallButton phoneNumber="8888411943" displayText="(888) 841-1943" />
      ...
      <Footer phoneNumber="8888411943" displayText="(888) 841-1943" />
