    ...
    <main className="w-full text-gray-800">
      ...
      >
        ...
        >
          ...
          <span className="font-extrabold text-lg">(888) 869-6316</span>
        </Link>
      ...
      <section className="w-full px-4 lg:px-80 py-8 bg-white">
        <div className="flex flex-col lg:flex-row items-center gap-10 py-8 border-b border-[#1b5bd04a] ">
          ...
          <div className="lg:w-1/2">
            ...
            <CallButton phoneNumber="8888696316" displayText="(888) 869-6316" />
      ...
      <Footer phoneNumber="8888696316" displayText="(888) 869-6316" />
